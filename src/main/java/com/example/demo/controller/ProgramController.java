...
public class ProgramController {
    ...
    //更新
    @PutMapping
    public Result update(Integer program_id,String program_name,String resolving_power,String program_time,String program_size,Integer program_state,String program_author,MultipartFile file, HttpServletRequest request)throws FileNotFoundException {
        Program program=new Program();
    ...
    public Result reName(@RequestBody  Program program){
        ...
        return Result.succ(200,"重命名成功",program);
    }
    //删除
    @DeleteMapping("/{id}")
